...
physeq <- qza_to_phyloseq(
  features="donor-core-metrics-results/rarefied_table.qza",
...
for(ml in my_level){
  ...
  physeq_meta_filtered$donor.type.ord = factor(physeq_meta_filtered$donor.type, c("donor-piglet", "donor-sow"))
