...
evenness = read_qza("donor-core-metrics-results/evenness_vector.qza")
...
observed_features = read_qza("donor-core-metrics-results/observed_features_vector.qza")
...
shannon = read_qza("donor-core-metrics-results/shannon_vector.qza")
...
faith_pd = read_qza("donor-core-metrics-results/faith_pd_vector.qza")
...
evenness_boxplot <- ggplot(meta, aes(donor.type.ord, pielou_evenness, fill = donor.type.ord)) + 
  ...
  scale_fill_manual(values = c("donor-piglet" = "gray", "donor-sow" = "lightblue"))
