...
evenness = read_qza("fecal-core-metrics-results/evenness_vector.qza")
...
observed_features = read_qza("fecal-core-metrics-results/observed_features_vector.qza")
...
shannon = read_qza("fecal-core-metrics-results/shannon_vector.qza")
...
faith_pd = read_qza("fecal-core-metrics-results/faith_pd_vector.qza")
...
donor_levels <- levels(meta$donor.type.ord)

kruskal.test(observed_features ~ donor.type.ord, data=meta)
...
pairwise.wilcox.test(meta$observed_features, meta$donor.type.ord, p.adjust.method="BH")
