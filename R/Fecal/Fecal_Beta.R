...
##Unweighted UniFrac##
uwuni_dist_mat<-read_qza("fecal-core-metrics-results/unweighted_unifrac_distance_matrix.qza")
...
##Jaccard##
jacc_dist_mat<-read_qza("fecal-core-metrics-results/jaccard_distance_matrix.qza")
