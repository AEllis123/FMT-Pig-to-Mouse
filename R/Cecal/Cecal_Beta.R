...
metadata2 <- read.delim("replicate-metadata-gnoto.txt", sep = "\t", header = T, quote = "", stringsAsFactors = F)
metadata2[1,]
metadata2[,1]
...
bc_PCoA<-read_qza("cecal-core-metrics-results/bray_curtis_pcoa_results.qza")
...
Wuni_PCoA<-read_qza("cecal-core-metrics-results/weighted_unifrac_pcoa_results.qza")
...
bc_dist_mat<-read_qza("cecal-core-metrics-results/bray_curtis_distance_matrix.qza")
...
UWuni_PCoA<-read_qza("cecal-core-metrics-results/unweighted_unifrac_pcoa_results.qza")
...
Jaccard_PCoA<-read_qza("cecal-core-metrics-results/jaccard_pcoa_results.qza")
...
##Weighted UniFrac##
wuni_dist_mat<-read_qza("cecal-core-metrics-results/weighted_unifrac_distance_matrix.qza")
...
##Unweighted UniFrac##
uwuni_dist_mat<-read_qza("cecal-core-metrics-results/unweighted_unifrac_distance_matrix.qza")
...
##Jaccard##
jacc_dist_mat<-read_qza("cecal-core-metrics-results/jaccard_distance_matrix.qza")
